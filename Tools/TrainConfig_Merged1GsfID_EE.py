...
OutputDirName = './Results/Output_Merged1GsfID_EE_2017_EGM'
Debug = False  # If True, only a 10% of events/objects are used for either Signal or background
Pickle_signal = './data/Merged-ID/Dataframe_MergedID_HDalitz_allprod_eeg_allMass_EE_2017.pkl'
Pickle_bkg = './data/Merged-ID/Dataframe_MergedID_GJets_EE_2017.pkl'
Clfname = 'MergedID'
#####################################################################
testsize = 0.2  # (0.2 means 20%)

# Common cuts for both signal and background (Would generally correspond to the training region)
CommonCut = "(XGB_pred >= 0.485) and (nGsfMatchToReco == 1) and (elePresel == True) and (nVtx > 1)"
...
featureplotparam_json = 'FeaturePlotParam_MergedIDEE1Gsf.json'

xgbmodeloutname = 'XGBoostModel_Merged1GsfID_EE.root'
...
# #####################################################################
# # All plots, models, config file will be stored here
# OutputDirName = './Results/Output_Merged1GsfID_EE_2017_llg'
# Debug = False  # If True, only a 10% of events/objects are used for either Signal or background
# Pickle_signal = './data/Merged-ID/Dataframe_MergedID_HDalitz_allprod_eeg_allMass_EE_2017.pkl'
# Pickle_bkg = './data/Merged-ID/Dataframe_MergedID_GJets_EE_2017.pkl'
# Clfname = 'MergedID'
...
# CommonCut = "(XGB_pred >= 0.512) and (nGsfMatchToReco == 1) and (elePresel == True) and (nVtx > 1)"
