...
OutputDirName = './Results/Output_Merged2GsfID_EB_2017_EGM'
...
CommonCut = "(XGB_pred >= 0.507) and (nGsfMatchToReco >= 2) and (elePresel == True) and (nVtx > 1)"
...
featureplotparam_json = 'FeaturePlotParam_MergedIDEB2Gsf.json'
