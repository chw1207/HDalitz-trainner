...
OutputDirName = './Results/Output_ResolvedMergedClassifier_EE_2017_EGM'
Debug = False  # If True, only a 10% of events/objects are used for either Signal or background
Picklefname = './data/Resolved-Merged-Classifier/Dataframe_ResolvedMerged_HDalitz_allprod_eeg_allMass_EE_2017.pkl'
Clfname = 'RMClf'
#####################################################################
...
featureplotparam_json = 'FeaturePlotParam_ResolvedMergedClf_EE.json'

xgbmodeloutname = 'XGBoostModel_EE.root'
