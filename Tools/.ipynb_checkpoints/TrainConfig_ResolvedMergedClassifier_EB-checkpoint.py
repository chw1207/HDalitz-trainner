...
OutputDirName = './Results/Output_ResolvedMergedClassifier_EB_scaleposweight_instweiRelXS_FeatureVer3'
Debug = False  # If True, only a 10% of events/objects are used for either Signal or background
Picklefname = './data/Resolved-Merged-Classifier/Dataframe_ResolvedMerged_HDalitz_allprod_eeg_m125_EB_2017.pkl'
Clfname = 'RMClf'
#####################################################################
...
featureplotparam_json = 'FeaturePlotParam_ResolvedMergedClf.json'
