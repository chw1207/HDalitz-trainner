...
OutputDirName = './Results/Output_Merged2GsfID_EE_2017_EGM'
...
CommonCut = "(XGB_pred >= 0.485) and (nGsfMatchToReco >= 2) and (elePresel == True) and (nVtx > 1)"
...
featureplotparam_json = 'FeaturePlotParam_MergedIDEE2Gsf.json'

xgbmodeloutname = 'XGBoostModel_Merged2GsfID_EE.root'
...
# #####################################################################
# # All plots, models, config file will be stored here
# OutputDirName = './Results/Output_Merged2GsfID_EE_2017_llg'
# Debug = False  # If True, only a 10% of events/objects are used for either Signal or background
# Pickle_signal = './data/Merged-ID/Dataframe_MergedID_HDalitz_allprod_eeg_allMass_EE_2017.pkl'
# Pickle_bkg = './data/Merged-ID/Dataframe_MergedID_GJets_EE_2017.pkl'
# Clfname = 'MergedID'
...
# CommonCut = "(XGB_pred >= 0.524) and (nGsfMatchToReco >= 2) and (elePresel == True) and (nVtx > 1)"
